module area_pat0_top (
    ...
    input  logic [15:0]  north_bus_i,
    input  logic [15:0]  south_bus_i,
    input  logic [15:0]  east_bus_i,
    input  logic [15:0]  west_bus_i,
    output logic [31:0]  pe_data_o
);
    area_bench_top #(
        .PATTERN(0)
    ) u_dut (
